...
import '../../processos/processos_store.dart';

class ContratoDetalhesPage extends StatefulWidget {
  late String contratoCodigo;
  ...
  @override
  State<ContratoDetalhesPage> createState() => _ContratoDetalhesPageState();
}

class _ContratoDetalhesPageState extends State<ContratoDetalhesPage> {
  ...
  Future<void> buscarInformacoesDoProcesso() async {
    processoStore.getProcessoDetalhes(widget.contratoCodigo).then((value) {
      value.fold(
        (l) {
